...
其中：虚线框起来的节点是远程仓库的节点，只有在本地仓库才需要体现出远程仓库的分支情况

![image-20220630104647033](03-Git-Fetch.assets/image-20220630104647033.png)



当执行 `git fetch` 命令后会更新本地仓库的远程分支状态，从而保持本地仓库的远程分支与远程仓库的分支状态以及数据一致性。

![image-20220630104854409](03-Git-Fetch.assets/image-20220630104854409.png)
